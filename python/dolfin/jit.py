...
def ffc_jit(ufl_form, form_compiler_parameters=None):
    ...
    p["cpp_optimize_flags"] = "-pthread -DNDEBUG -g -fwrapv -O2 -Wall -g -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -fPIC"  # noqa
